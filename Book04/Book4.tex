...
a\kern -.7pt >ut~hc >ep`i t~hc perifere'iac >~h| to~u k'uklou.}}
...
\gr{E>ic t`on doj'enta k'uklon t~h| doje'ish| e>uje'ia| m\kern -.7pt `h me'izoni o>'ush|
t~hc to~u k'uklou diam'etrou >'ishn e>uje~ian >enarm'osai.}\\

\epsfysize=2.2in
\centerline{\epsffile{Book04/fig01g.eps}}

\gr{>'Estw <o doje`ic k'ukloc <o ABG, <h d`e doje~isa e>uje~ia m\kern -.7pt `h
...
ka`i sunest'atw pr`oc t~h| AJ e>uje'ia| ka`i t~w| pr`oc a\kern -.7pt >ut~h| shme'iw|
t~w| A t~h| <up`o DEZ gwn'ia| >'ish <h <up`o
JAG, pr`oc d`e t~h| AH e>uje'ia| ka`i t~w| pr`oc a\kern -.7pt >ut~h|
...
k'uklou tm\kern -.7pt 'hmati gwn'ia| t~h| <up`o ABG. >all> <h <up`o JAG t~h|
<up`o DEZ >estin >'ish; ka`i <h <up`o ABG >'ara gwn'ia t~h| <up`o
DEZ >estin >'ish. di`a t`a a\kern -.7pt >ut`a d`h ka`i <h <up`o AGB t~h| <up`o
...
ka`i t~w| pr`oc a\kern -.7pt >ut~h| shme'iw| t~w| K t~h| m`en <up`o DEH gwn'ia|
...
\gr{Tetm\kern -.7pt 'hsjwsan a<i <up`o ABG, AGB gwn'iai d'iqa ta~ic BD, GD e>uje'iaic,
...
<up`o m'ian
t~wn >'iswn gwni~wn koin`hn a\kern -.7pt >ut~wn t`hn
BD; ka`i t`ac loip`ac >'ara pleur`ac ta~ic loipa~ic pleura~ic >'isac
<'exousin; >'ish >'ara <h DE t~h| DZ. di`a t`a a\kern -.7pt >ut`a d`h ka`i <h
...
a\kern -.7pt >ut'ac, >'estai <h t~h| diam'etrw| to~u k'uklou pr`oc >orj`ac
>ap> >'akrac >agom'enh >ent`oc p'iptousa to~u k'uklou; <'oper
>'atopon >ede'iqjh; o>uk >'ara <o k'entrw| t~w| D diast'hmati
d`e <en`i t~wn E, Z, H graf'omenoc k'ukloc teme~i t`ac AB, BG, GA e>uje'iac; >ef'ayetai >'ara a\kern -.7pt >ut~wn, ka`i >'estai <o 
...
\gr{Tetm\kern -.7pt 'hsjwsan a<i AB, AG e>uje~iai d'iqa kat`a t`a D, E shme~ia, ka`i
...
>est'in. di`a t`a a\kern -.7pt >ut`a d`h ka`i <ekat'era t~wn BG, GD <ekat'era|  t~wn AB, 
...
<h <up`o BAD gwn'ia. di`a t`a a\kern -.7pt >ut`a d`h ka`i <ek'asth t~wn <up`o ABG, BGD, GDA >orj'h >estin; >orjog'wnion >'ara >est`i t`o ABGD tetr'apleuron.
...
>'ara pr`oc t~w| A gwn'iai >orja'i e>isin. di`a t`a a\kern -.7pt >ut`a d`h ka`i a<i
pr`oc to~ic B, G, D shme'ioic gwn'iai >orja'i e>isin. ka`i >epe`i
>orj'h >estin <h <up`o AEB gwn'ia, >est`i d`e >orj`h ka`i <h <up`o
EBH, par'allhloc >'ara >est`in <h HJ t~h| AG. di`a t`a a\kern -.7pt >ut`a
...
\gr{Tetm\kern -.7pt 'hsjw <ekat'era t~wn AD, AB d'iqa kat`a t`a E, Z shme~ia, ka`i
...
AJ, JD, AH, HG, BH, HD, ka`i a<i >apenant'ion a\kern -.7pt >ut~wn pleura`i
...
>'ara a\kern -.7pt >ut~wn ka`i >'estai >eggegramm'enoc e>ic t`o ABGD tetr'agwnon.}
...
>est'in; <h >'ara <up`o DAB gwn'ia d'iqa t'etm\kern -.7pt htai <up`o t~hc AG. <omo'iwc
d`h de'ixomen, <'oti ka`i <ek'asth t~wn <up`o ABG, BGD, GDA d'iqa
t'etm\kern -.7pt htai <up`o t~wn AG, DB e>ujei~wn. ka`i >epe`i >'ish
...
\gr{>Ekke'isjw tic e>uje~ia <h AB, ka`i tetm\kern -.7pt 'hsjw kat`a t`o G shme~ion,
...
e>ic t`on BDE k'uklon t~h| AG e>uje'ia| m\kern -.7pt `h me'izoni o>'ush| t~hc
...
prospept'wkasi d'uo e>uje~iai a<i BA, BD, ka`i <h m`en a\kern -.7pt >ut~wn
...
t~h| >en t~w| >enall`ax to~u k'uklou tm\kern -.7pt 'hmati gwn'ia|
...
t~hc <up`o GAD >esti dipl~h. tetm\kern -.7pt 'hsjw d`h <ekat'era t~wn <up`o
...
>est`i t~hc <up`o GAD, ka`i tetm\kern -.7pt hm'enai e>is`i d'iqa <up`o t~wn GE,
...
t~h| <up`o AED >estin >'ish. di`a t`a a\kern -.7pt >ut`a d`h ka`i <ek'asth t~wn
...
>efapt'omenai a<i HJ, JK, KL, LM, m\kern -.7pt h, ka`i e>il'hfjw to~u ABGDE
...
<ekat'era t~wn pr`oc t~w| G gwni~wn. di`a t`a a\kern -.7pt >ut`a d`h ka`i a<i 
pr`oc to~ic B, D shme'ioic gwn'iai  >orja'i e>isin. ka`i >epe`i >orj'h 
>estin <h <up`o ZGK gwn'ia, t`o >'ara >ap`o t~hc ZK >'ison 
>est`i to~ic >ap`o t~wn ZG, GK. di`a t`a a\kern -.7pt >ut`a d`h ka`i to~ic 
...
<h d`e <up`o BKG t~hc <up`o ZKG. di`a t`a a\kern -.7pt >ut`a d`h ka`i <h
...
m'ian pleur`an mi~a| pleur~a| >'ishn koin`hn a\kern -.7pt >ut~wn
...
<h KG t~h| GL, dipl~h >'ara <h KL t~hc KG. di`a t`a a\kern -.7pt >uta
...
>'ish; a<i p'ente >'ara gwn'iai a<i <up`o HJK, JKL, KLM, Lm\kern -.7pt h,
m\kern -.7pt hJ
...
\gr{Tetm\kern -.7pt 'hsjw g`ar <ekat'era t~wn <up`o BGD, GDE gwni~wn d'iqa <up`o
...
ZBG; <h >'ara <up`o ABG gwn'ia d'iqa t'etm\kern -.7pt htai <up`o t~hc
BZ e>uje'iac. <omo'iwc d`h deiqj'hsetai, <'oti ka`i <ekat'era t~wn
<up`o BAE, AED d'iqa t'etm\kern -.7pt htai <up`o <ekat'erac t~wn ZA, ZE
...
>'eqonta ka`i m'ian pleur`an mi~a| pleur~a| >'ishn koin`hn a\kern -.7pt >ut~wn 
...
\gr{Tetm\kern -.7pt 'hsjw d`h <ekat'era t~wn <up`o BGD, GDE gwni~wn d'iqa
...
gwni~wn d'iqa t'etm\kern -.7pt htai <up`o <ek'asthc t~wn ZB, ZA, ZE
...
>is'opleuron >'ara >est`i t`o EHD tr'igwnon; ka`i a<i tre~ic >'ara a\kern -.7pt >uto~u
...
>all'hlaic e>is'in; <'wste ka`i a<i kat`a koruf`hn a\kern -.7pt >uta~ic a<i <up`o
...
to~u e>ic a\kern -.7pt >ut`on >eggrafom'enou pleur`a <h AG, pentag'wnou d`e
>isople'urou <h AB; o<'iwn >'ara >est`in <o ABGD k'ukloc >'iswn
tm\kern -.7pt 'hmatwn dekap'ente, toio'utwn <h m`en ABG perif'ereia tr'iton
o>~usa to~u k'uklou >'estai p'ente, <h d`e AB perif'ereia p'emton
o>~usa to~u k'uklou >'estai tri~wn; loip`h >'ara <h BG t~wn
>'iswn d'uo. tetm\kern -.7pt 'hsjw <h BG d'iqa kat`a t`o E; <ekat'era >'ara t~wn
BE, EG periferei~wn pentekaid'ekat'on >esti to~u ABGD k'uklou.}

\gr{>E`an >'ara >epize'uxantec t`ac BE, EG >'isac a\kern -.7pt >uta~ic kat`a 
t`o suneq`ec e>uje'iac >enarm'oswmen e>ic t`on ABGD[E]
k'uklon, >'estai e>ic a\kern -.7pt >ut`on >eggegramm'enon pentekaidek'agwnon
