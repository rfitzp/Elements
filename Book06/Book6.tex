...
\ggn{2}.~\gr{>'Akron ka`i m'eson l'ogon e>uje~ia tetm\kern -.7pt ~hsjai l'egetai, <'otan >~h|
<wc <h <'olh pr`oc t`o me~izon tm\kern -.7pt ~hma, o<'utwc t`o me~izon
pr`oc t`o >'elatt`on.}
...
\gr{T`a tr'igwna ka`i t`a parallhl'ogramma t`a <up`o t`o a\kern -.7pt >ut`o <'uyoc >'onta
...
<up`o t`o a\kern -.7pt >ut`o <'uyoc t`o AG; l'egw, <'oti >est`in <wc <h BG b'asic
pr`oc t`hn GD b'asin, o<'utwc t`o ABG tr'igwnon pr`oc t`o AGD
...
to~u ABG trig'wnou. di`a t`a a\kern -.7pt >ut`a d`h <osaplas'iwn >est`in <h LG b'asic
...
parallhl'ogrammon, t`a d`e m'erh to~ic <wsa\kern -.7pt 'utwc pollaplas'ioic t`on
a\kern -.7pt >ut`on >'eqei l'ogon, >'estin >'ara <wc t`o ABG tr'igwnon pr`oc
...
\gr{T`a >'ara  tr'igwna ka`i t`a parallhl'ogramma t`a <up`o t`o a\kern -.7pt >ut`o <'uyoc >'onta
...
>an'alogon tm\kern -.7pt hj~wsin, <h >ep`i t`ac tom`ac >epizeugnum'enh e>uje~ia
...
a\kern -.7pt >ut~hc b'ase'wc >esti t~hc DE ka`i >en ta~ic a\kern -.7pt >uta~ic parall'hloic ta~ic
DE, BG; >'allo d'e ti t`o ADE tr'igwnon. t`a d`e >'isa pr`oc t`o a\kern -.7pt >ut`o
t`on a\kern -.7pt >ut`on >'eqei l'ogon; >'estin >'ara <wc t`o BDE tr'igwnon
...
BD pr`oc t`hn DA; <up`o g`ar t`o a\kern -.7pt >ut`o <'uyoc >'onta t`hn >ap`o to~u
E >ep`i t`hn AB k'ajeton >agom'enhn pr`oc >'allhl'a e>isin <wc a<i
b'aseic. di`a t`a a\kern -.7pt >ut`a d`h <wc t`o GDE tr'igwnon pr`oc t`o ADE, o<'utwc
...
tetm\kern -.7pt 'hsjwsan, <wc <h BD pr`oc t`hn DA, o<'utwc <h GE pr`oc t`hn
EA, ka`i >epeze'uqjw <h DE; l'egw, <'oti par'allhl'oc >estin <h DE
t~h| BG.}

\gr{T~wn g`ar a\kern -.7pt >ut~wn kataskeuasj'entwn, >epe'i >estin <wc <h BD pr`oc
...
trig'wnwn pr`oc t`o ADE t`on a\kern -.7pt >ut`on >'eqei l'ogon. >'ison
>'ara >est`i t`o BDE tr'igwnon t~w| GDE trig'wnw|; ka'i e>isin >ep`i t~hc
a\kern -.7pt >ut~hc b'asewc t~hc DE. t`a d`e >'isa tr'igwna ka`i >ep`i t~hc a\kern -.7pt >ut~hc
b'asewc >'onta ka`i >en ta~ic a\kern -.7pt >uta~ic parall'hloic >est'in. par'allhloc
...
\gr{>E`an trig'wnou <h gwn'ia d'iqa tm\kern -.7pt hj~h|, <h d`e t'emnousa t`hn gwn'ian
e>uje~ia t'emnh| ka`i t`hn b'asin, t`a t~hc b'asewc tm\kern -.7pt 'hmata t`on 
a\kern -.7pt >ut`on <'exei l'ogon ta~ic loipa~ic to~u trig'wnou pleura~ic;
ka`i >e`an t`a t~hc b'asewc tm\kern -.7pt 'hmata t`on a\kern -.7pt >ut`on >'eqh| l'ogon
ta~ic loipa~ic to~u trig'wnou pleura~ic, <h >ap`o t~hc koruf~hc >ep`i
t`hn tom\kern -.7pt `hn >epizeugnum'enh e>uje~ia d'iqa teme~i t`hn to~u
trig'wnou gwn'ian.}

\gr{>'Estw tr'igwnon t`o ABG, ka`i tetm\kern -.7pt 'hsjw <h <up`o BAG gwn'ia d'iqa
...
<h BA sumpipt'etw a\kern -.7pt >ut~h| kat`a t`o E.}
...
t'etm\kern -.7pt htai <h <up`o BAG gwn'ia <up`o t~hc AD e>uje'iac.}

\gr{T~wn g`ar a\kern -.7pt >ut~wn kataskeuasj'entwn, >epe'i >estin <wc <h BD
...
GAD >estin >'ish. <h >'ara <up`o BAG gwn'ia d'iqa t'etm\kern -.7pt htai
<up`o t~hc AD e>uje'iac.}

\gr{>E`an >'ara trig'wnou <h gwn'ia d'iqa tm\kern -.7pt hj~h|, <h d`e t'emnousa t`hn gwn'ian
e>uje~ia t'emnh| ka`i t`hn b'asin, t`a t~hc b'asewc tm\kern -.7pt 'hmata t`on 
a\kern -.7pt >ut`on <'exei l'ogon ta~ic loipa~ic to~u trig'wnou pleura~ic;
ka`i >e`an t`a t~hc b'asewc tm\kern -.7pt 'hmata t`on a\kern -.7pt >ut`on >'eqh| l'ogon
ta~ic loipa~ic to~u trig'wnou pleura~ic, <h >ap`o t~hc koruf~hc >ep`i
t`hn tom\kern -.7pt `hn >epizeugnum'enh e>uje~ia d'iqa t'emnei t`hn to~u
...
a\kern -.7pt >ut~h| shme'ioic to~ic E, Z t~h| m`en <up`o ABG gwn'ia|
...
EZ t`on a\kern -.7pt >ut`on >'eqei l'ogon; >'ish >'ara >est`in <h DE t~h| HE. di`a
t`a a\kern -.7pt >ut`a d`h ka`i <h DZ t~h| HZ >estin >'ish. >epe`i  o>~un >'ish
...
di`a t`a a\kern -.7pt >ut`a d`h ka`i <h <up`o AGB t~h| <up`o DZE >estin >'ish,
...
\gr{Sunest'atw g`ar pr`oc t~h| DZ e>uje'ia| ka`i to~ic pr`oc a\kern -.7pt >ut~h| shme'ioic
...
>'ish >'ara >est`in <h m`en <up`o DZH t~h| <up`o DZE, <h d`e <up`o
...
<'ama >'htoi >el'assona >`h m\kern -.7pt `h >el'assona >orj~hc, >isog'wnia >'estai
...
DEZ, m'ia a\kern -.7pt >ut~wn me'izwn >est'in. >'estw me'izwn <h <up`o
ABG. ka`i sunest'atw pr`oc t~h| AB e>uje'ia| ka`i t~w|
pr`oc a\kern -.7pt >ut~h| shme'iw| t~w| B t~h| <up`o DEZ gwn'ia| >'ish <h
<up`o ABH.}
...
BG; <h AB >'ara pr`oc <ekat'eran t~wn BG, BH t`on a\kern -.7pt >ut`on >'eqei
...
ka`i <up`o BHG;  <'wste <h >efex~hc a\kern -.7pt >ut~h| gwn'ia <h <up`o AHB
...
\gr{>All`a d`h p'alin <upoke'isjw <ekat'era t~wn pr`oc to~ic G, Z m\kern -.7pt `h
...
\gr{>E`an >'ara d'uo tr'igwna m'ian gwn'ian mi~a| gwn'ia| >'ishn >'eqh|, per`i
d`e >'allac gwn'iac t`ac pleur`ac >an'alogon, t~wn d`e loip~wn <ekat'eran
<'ama  >el'attona >`h m\kern -.7pt `h >el'attona >orj~hc, >isog'wnia >'estai
t`a tr'igwna ka`i >'isac <'exei t`ac gwn'iac,
...
AGB loip~h| t~h| <up`o BAD >estin >'ish; >isog'wnion >'ara >est`i
...
t`hn >orj`hn  to~u ABD trig'wnou, o<'utwc a\kern -.7pt >ut`h <h AB <upote'inousa t`hn
...
>estin >'ish, >all`a m\kern -.7pt `hn ka`i <h <up`o BAD t~h| pr`oc t~w| G
...
t`hn pr`oc t~w| G  >'ishn t~h| <up`o BAD, o<'utwc a\kern -.7pt >ut`h <h AD
...
k'ajetoc >aqj~h|, <h >aqje~isa t~wn t~hc b'asewc tm\kern -.7pt hm'atwn
...
\gr{T`hn doje~isan e>uje~ian >'atm\kern -.7pt hton t~h| doje'ish| tetm\kern -.7pt hm'enh| <omo'iwc
teme~in.}

\gr{>'Estw <h m`en doje~isa e>uje~ia <'atm\kern -.7pt htoc <h AB,
<h d`e tetm\kern -.7pt hm'enh <h AG kat`a t`a D, E shme~ia, ka`i ke'isjwsan
...
\gr{<H >'ara doje~isa e>uje~ia >'atm\kern -.7pt htoc <h AB t~h| doje'ish| e>uje'ia|
tetm\kern -.7pt hm'enh| t~h| AG <omo'iwc t'etm\kern -.7pt htai; <'oper >'edei poi~hsai;}}
...
>epeze'uqjw <h BG, ka`i di`a to~u D par'allhloc a\kern -.7pt >ut~h|
>'hqjw <h DE.}\\~\\~\\
...
a\kern -.7pt >uta~ic prose'urhtai <h GE; <'oper >'edei poi~hsai.}}
...
\gr{>Ekke'isjwsan d'uo e>uje~iai a<i DE, DZ gwn'ian peri'eqousai [tuqo~usan]
...
a\kern -.7pt >ut~h| >'hqjw di`a to~u E <h EZ.}
...
>orj`ac <h BD, ka`i >epeze'uqjwsan a<i AD, DG.}
...
>~hktai <h DB, <h DB >'ara t~wn t~hc b'asewc tm\kern -.7pt hm'atwn
...
t~wn ABG, EAD pr`oc t`o BAD t`on a\kern -.7pt >ut`on >'eqei l'ogon. >'iswn
...
\gr{T~wn g`ar a\kern -.7pt >ut~wn kataskeuasj'entwn, >epe`i t`o <up`o t~wn AB, Z
...
\gr{T~wn g`ar a\kern -.7pt >ut~wn kataskeuasj'entwn, >epe`i t`o <up`o t~wn A, G
...
\gr{>'Estw <h m`en doje~isa e>uje~ia <h AB, t`o d`e doj`en e>uj'ugramm\-on t`o GE;
...
to~ic pr`oc a\kern -.7pt >ut~h| shme'ioic to~ic A, B t~h| m`en pr`oc t~w| G
...
HB, o<'utwc <h ZG pr`oc t`hn HA, ka`i <h GD pr`oc t`hn AB. p'alin sunest'atw pr`oc t~h| BH e>uje'ia| ka`i to~ic pr`oc a\kern -.7pt >ut~h| shme'ioic
...
ZE pr`oc t`hn HJ ka`i <h ED pr`oc t`hn JB. >ede'iqjh d`e ka`i <wc <h ZD
 ...
 >'ara <h <up`o GZE <'olh| t~h| <up`o AHJ >estin >'ish. di`a t`a a\kern -.7pt >ut`a
...
pr`oc t~w| E t~h| pr`oc t~w| J. >isog'wnion >'ara >est`i t`o AJ t~w| GE;
 ka`i t`ac per`i t`ac >'isac gwn'iac a\kern -.7pt >ut~wn pleur`ac >an'alogon
...
>est`in <h EZ pr`oc BH. ka`i <wc >'ara <h AB pr`oc DE, o<'utwc
...
<h LH pr`oc HZ, 
>all`a m\kern -.7pt `hn ka`i di`a t`hn <omoi'othta t~wn polug'wnwn
...
trig'wnw. di`a t`a a\kern -.7pt >ut`a d`h ka`i t`o EGD tr'igwnon <'omoi'on
...
e>~inai t`a tr'igwna, ka`i <hgo'umena m`en e>~inai t`a ABE, EBG, EGD, <ep'omena d`e a\kern -.7pt >ut~wn t`a ZHL, LHJ, LJK, ka`i <'oti t`o ABGDE pol'ugwnon pr`oc t`o ZHJKL pol'ugwnon diplas'iona l'ogon >'eqei
...
tr'igwnon pr`oc t`o EBG tr'igwnon. di`a t`a a\kern -.7pt >ut`a d`h ka`i <wc <h ZN pr`oc
...
\gr{<Wsa\kern -.7pt 'utwc d`e ka`i >ep`i t~wn [<omo'iwn] tetraple'urwn deiqj'h\-setai, 
...
\gr{T`a t~w| a\kern -.7pt >ut~w| e>ujugr'ammw| <'omoia ka`i >all'hloic >est`in <'omoia.}\\
...
a\kern -.7pt >ut~w| ka`i t`ac per`i t`ac >'isac gwn'iac pleur`ac >an'alogon
>'eqei. p'alin, >epe`i <'omoi'on >esti t`o B t~w| G, >isog'wni'on
t'e >estin a\kern -.7pt >ut~w| ka`i t`ac per`i t`ac >'isac gwn'iac pleur`ac >an'alogon
...
>'estai; k>`an t`a >ap> a\kern -.7pt >ut~wn e>uj'ugramma <'omoi'a te ka`i <omo'iwc
>anagegramm'ena >an'alogon >~h|, ka`i a\kern -.7pt >ut`ai a<i e>uje~iai >an'alogon
>'esontai.}
...
GD, o<'utwc <h EZ pr`oc  t`hn HJ. e>i g`ar m\kern -.7pt 'h >estin, <wc <h AB
...
t~wn NJ, SR t`on a\kern -.7pt >ut`on >'eqei l'ogon; >'ison >'ara >est`i t`o NJ t~w|
SR. >'esti d`e a\kern -.7pt >ut~w| ka`i <'omoion ka`i <omo'iwc ke'imenon; >'ish >'ara
...
\gr{>E`an >'ara t'essarec e>uje~iai >an'alogon >~wsin, ka`i t`a >ap> a\kern -.7pt >ut~wn
e>uj'ugramma <'omoi'a te ka`i <omo'iwc >anagegramm'ena >an'alogon
>'estai; k>`an t`a >ap> a\kern -.7pt >ut~wn e>uj'ugramma <'omoi'a te ka`i <omo'iwc
>anagegramm'ena >an'alogon >~h|, ka`i a\kern -.7pt >ut`ai a<i e>uje~iai >an'alogon
...
a\kern -.7pt >uto'i e>isi to~ic l'ogoic t~wn pleur~wn, t~hc te BG pr`oc t`hn
...
\gr{>'Estw parallhl'ogrammon t`o ABGD, di'ametroc d`e a\kern -.7pt >uto~u <h AG,
...
t`a a\kern -.7pt >ut`a d`h ka`i t`o AGB tr'igwnon >isog'wni'on >esti t~w| AZE trig'wnw|,
...
di`a t`a a\kern -.7pt >ut`a d`h t`o ABGD parallhl'ogrammon ka`i t~w| KJ parallhlogr'ammw| <'omoi'on >estin; <ek'ateron >'ara t~wn EH, JK
parallhlogr'ammwn t~w| ABGD [parallhlogr'ammw|] <'omoi'on
>estin. t`a d`e t~w| a\kern -.7pt >ut~w| e>ujugr'ammw| <'omoia ka`i >all'hloic
...
>'ison t`o a\kern -.7pt >ut`o sust'hsasjai.}\\

\epsfysize=1.35in
\centerline{\epsffile{Book06/fig25g.eps}}

\gr{>'Estw t`o m`en doj`en e>uj'ugrammon, <~w| de~i <'omoion
sust'hsasj\-ai, t`o ABG, <~w| d`e de~i >'ison, t`o D; de~i d`h
t~w| m`en ABG <'omoion, t~w| d`e D >'ison t`o a\kern -.7pt >ut`o
sust'hsasjai.}
...
>'ison t`o a\kern -.7pt >ut`o sun'estatai t`o KHJ; <'oper >'edei poi~hsai.}}
...
>'eqon a\kern -.7pt >ut~w|, per`i t`hn a\kern -.7pt >ut`hn di'ametr'on >esti t~w| <'olw|.}

\gr{>Ap`o g`ar parallhlogr'ammou to~u ABGD parallhl'ogra\-mmon
>afh|r'hsjw t`o AZ <'omoion t~w| ABGD ka`i <omo'iwc ke'imenon
koin`hn gwn'ian >'eqon a\kern -.7pt >ut~w| t`hn <up`o DAB; l'egw, <'oti
per`i t`hn a\kern -.7pt >ut`hn di'ametr'on >esti t`o ABGD t~w| AZ.}\\

\epsfysize=2in
\centerline{\epsffile{Book06/fig26g.eps}}

\gr{m\kern -.7pt `h g'ar, >all> e>i dunat'on, >'estw [a\kern -.7pt >ut~wn] di'ametroc
<h AJG, ka`i >ekblhje~isa <h HZ di'hqjw >ep`i t`o J, ka`i >'hqjw
di`a to~u J <opor'era| t~wn AD, BG par'allhloc <h JK.}

\gr{>Epe`i o>~un per`i t`hn a\kern -.7pt >ut`hn di'ametr'on >esti t`o ABGD t~w| KH,
...
<ekat'eran t~wn AK, AE t`on a\kern -.7pt >ut`on >'eqei l'ogon. >'ish
>'ara >est`in <h AE t~h| AK <h >el'attwn t~h| me'izoni; <'oper
>est`in >ad'unaton. o>uk >'ara o>'uk >esti per`i t`hn a\kern -.7pt >ut`hn
di'ametron t`o ABGD t~w| AZ; per`i t`hn a\kern -.7pt >ut`hn >'ara >est`i di'ametron
...
\gr{P'antwn t~wn par`a t`hn a\kern -.7pt >ut`hn e>uje~ian paraballom'enwn parallhlogr'ammwn ka`i >elleip'ontwn e>'idesi parallhlogr'am\-moic
...
\gr{>'Estw e>uje~ia <h AB ka`i tetm\kern -.7pt 'hsjw d'iqa kat`a t`o G, ka`i parabebl'hsjw
...
parallhlogr'ammw|, per`i t`hn a\kern -.7pt >ut'hn e>isi di'ametron. >'hqjw
a\kern -.7pt >ut~wn di'ametroc <h DB, ka`i katagegr'afjw t`o sq~hma.}
...
\gr{P'antwn >'ara t~wn par`a t`hn a\kern -.7pt >ut`hn e>uje~ian paraballom'enwn
...
[<~w| de~i >'ison parabale~in] m\kern -.7pt `h me~izon e>~inai to~u >ap`o 
t~hc <hmise'iac >anagrafom'enou <omo'iou t~w|  >elle'immati
[to~u te >ap`o t~hc <hmise'iac ka`i <~w| de~i <'omoion
>elle'ipein].}

\gr{>'Estw <h m`en doje~isa e>uje~ia <h AB, t`o d`e doj`en e>uj'ugramm\-on,
<~w| de~i >'ison par`a  t`hn AB parabale~in, t`o G m\kern -.7pt `h me~izon
...
\gr{Tetm\kern -.7pt 'hsjw <h AB d'iqa kat`a t`o E shme~ion, ka`i >anagegr'afjw
...
ka`i t`o HB to~u G. <~w| d`h me~iz'on >esti t`o HB to~u G, 
 ta\kern -.7pt 'uth| t~h| <uperoq~h| >'ison, t~w| d`e D <'omoion
ka`i <omo'iwc ke'imenon t`o a\kern -.7pt >ut`o sunest'atw t`o KLMN. 
...
per`i t`hn a\kern -.7pt >ut`hn >'ara di'ametr'on >esti t`o HP
t~w| HB. >'estw a\kern -.7pt >ut~wn 
...
\gr{Tetm\kern -.7pt 'hsjw <h AB d'iqa kat`a t`o E, ka`i >anagegr'ajw >ap`o t~hc
...
ke'imenon t`o a\kern -.7pt >ut`o sunest'atw t`o HJ. <om'ologoc
...
>estin; per`i t`hn a\kern -.7pt >ut`hn >'ara di'ametr'on >esti t`o EL t~w| MN.
>'hqjw a\kern -.7pt >ut~wn di'ametroc <h ZX, ka`i katagegr'afjw t`o sq~hma.}
...
loip`on >'ara t`o BZ loip~w| t~w| AD >estin >'ison. >'esti d`e a\kern -.7pt >ut~w| ka`i
...
\gr{<H >'ara AB e>uje~ia >'akron ka`i m'eson l'ogon t'etm\kern -.7pt htai kat`a t`o E,
ka`i t`o me~izon a\kern -.7pt >ut~hc tm\kern -.7pt ~hm'a >esti t`o AE; <'oper >'edei
poi~hsai.}}
...
<'omoion ka`i <omo'iwc >anagraf'omenon. di`a t`a a\kern -.7pt >ut`a d`h ka`i
...
dus`i pleura~ic >an'alogon >'eqonta <'wste t`ac <omol'ogouc a\kern -.7pt >ut~wn
...
\gr{>Epe`i g`ar par'allhl'oc >estin <h AB t~h| DG, ka`i e>ic a\kern -.7pt >ut`ac
>emp'eptwken e>uje~ia <h AG, a<i >enall`ax gwn'iai a<i <up`o BAG,
AGD >'isai >all'hlaic e>is'in. di`a t`a a\kern -.7pt >ut`a d`h ka`i <h <up`o GDE
...
>'isai e>is'in. pr`oc d'h tini e>uje'ia| t~h| AG ka`i t~w| pr`oc a\kern -.7pt >ut~h|
shme'iw| t~w| G d'uo e>uje~iai a<i BG, GE m\kern -.7pt `h >ep`i t`a a\kern -.7pt >ut`a m'erh
...
\gr{>En to~ic >'isoic k'ukloic a<i gwn'iai t`on a\kern -.7pt >ut`on >'eqousi l'ogon ta~ic
...
m`en to~ic k'entroic a\kern -.7pt >ut~wn to~ic H, J gwn'iai >'estwsan a<i <up`o
...
t`a a\kern -.7pt >ut`a d`h ka`i <osaplas'iwn  >est`in <h NE perif'ereia t~hc EZ,
...
\gr{>En >'ara to~ic >'isoic k'ukloic a<i gwn'iai t`on a\kern -.7pt >ut`on >'eqousi l'ogon ta~ic
perifere'iaic, >ef> <~wn beb'hkasin, >e'an te pr`oc to~ic k'entroic
