...
a\kern -.7pt >uto~u parallhlogr'ammwn <`en <opoiono~un s`un to~ic dus`i paraplhr'wmasi gn'wmwn kale'isjw.}}
...
\gr{>E`an >~wsi d'uo e>uje~iai, tm\kern -.7pt hj~h| d`e <h <et'era a\kern -.7pt >ut~wn e>ic <osadhpoto~un tm\kern -.7pt 'hmata, t`o perieq'omenon >orjog'wnion <up`o t~wn d'uo e>ujei~wn >'ison >est`i to~ic <up'o te t~hc >atm\kern -.7pt 'htou ka`i <ek'astou t~wn tm\kern -.7pt hm'atwn perieqom'enoic >orjogwn'ioic.}\\

\epsfysize=2.2in
\centerline{\epsffile{Book02/fig01g.eps}}

\gr{>'Estwsan d'uo e>uje~iai a<i A, BG, ka`i tetm\kern -.7pt 'hsjw <h BG, <wc >'etuqen, kat`a t`a D, E shme~ia; l'egw, <'oti t`o <up`o t~wn A, BG perieqom'enon >orjog'wnion >'ison >est`i t~w| te <up`o t~wn A, BD perieqom'enw| >orjogwn'iw| ka`i t~w| <up`o t~wn A, DE ka`i >'eti t~w| <up`o t~wn A,
EG.}
...
\gr{>E`an >'ara  >~wsi d'uo e>uje~iai, tm\kern -.7pt hj~h| d`e <h <et'era a\kern -.7pt >ut~wn e>ic <osadhpoto~un tm\kern -.7pt 'hmata, t`o perieq'omenon >orjog'wnion <up`o t~wn d'uo e>ujei~wn >'ison >est`i to~ic <up'o te t~hc >atm\kern -.7pt 'htou ka`i <ek'astou t~wn tm\kern -.7pt hm'atwn perieqom'enoic >orjogwn'ioic; <'oper >'edei de~ixai.}}
...
\gr{>E`an e>uje~ia gramm\kern -.7pt `h tm\kern -.7pt hj~h|, <wc >'etuqen, t`o <up`o t~hc <'olhc ka`i <ekat'erou t~wn tm\kern -.7pt hm'atwn perieq'omenon >orjog'wnion >'ison >est`i t~w| >ap`o t~hc <'olhc tetrag'wnw|.}\\

\epsfysize=2.2in
\centerline{\epsffile{Book02/fig02g.eps}}

\gr{E>uje~ia g`ar <h AB tetm\kern -.7pt 'hsjw, <wc >'etuqen, kat`a t`o G shme~ion; l'egw, 
...
\gr{>E`an >'ara e>uje~ia gramm\kern -.7pt `h tm\kern -.7pt hj~h|, <wc >'etuqen, t`o <up`o t~hc <'olhc ka`i <ekat'erou t~wn tm\kern -.7pt hm'atwn perieq'omenon >orjog'wnion >'ison >est`i t~w| >ap`o t~hc <'olhc tetrag'wnw|; <'oper >'edei de~ixai.}}
...
\gr{>E`an e>uje~ia gramm\kern -.7pt `h tm\kern -.7pt hj~h|, <wc >'etuqen, t`o <up`o t~hc <'olhc ka`i <en`oc t~wn tm\kern -.7pt hm'atwn perieq'omenon >orjog'wnion >'ison >est`i t~w| te <up`o t~wn tm\kern -.7pt hm'atwn perieqom'enw| >orjogwn'iw| ka`i t~w| >ap`o to~u proeirhm'enou tm\kern -.7pt 'hmatoc tetrag'wnw|.}

\epsfysize=2.in
\centerline{\epsffile{Book02/fig03g.eps}}

\gr{E>uje~ia g`ar <h AB tetm\kern -.7pt 'hsjw, <wc >'etuqen, kat`a t`o G; l'egw, <'oti
...
\gr{>E`an >'ara e>uje~ia gramm\kern -.7pt `h tm\kern -.7pt hj~h|, <wc >'etuqen, t`o <up`o t~hc <'olhc ka`i <en`oc t~wn tm\kern -.7pt hm'atwn perieq'omenon >orjog'wnion >'ison >est`i t~w| te <up`o t~wn tm\kern -.7pt hm'atwn perieqom'enw| >orjogwn'iw| ka`i t~w| >ap`o to~u proeirhm'enou tm\kern -.7pt 'hmatoc tetrag'wnw|; <'oper >'edei de~ixai.}}
...
\gr{>E`an e>uje~ia gramm\kern -.7pt `h tm\kern -.7pt hj~h|, <wc >'etuqen, t`o >ap`o t~hc <'olhc tetr'agwnon >'ison >est`i to~ic te >ap`o t~wn tm\kern -.7pt hm'atwn tetrag'wnoic ka`i t~w| d`ic <up`o t~wn tm\kern -.7pt hm'atwn perieqom'enw| >orjogwn'iw|.}

\gr{E>uje~ia g`ar gramm\kern -.7pt `h <h AB tetm\kern -.7pt 'hsjw, <wc >'etuqen, kat`a t`o G. l'egw,
...
JK. ka`i >epe`i par'allhl'oc >estin <h GZ t~h| AD, ka`i e>ic a\kern -.7pt >ut`ac >emp'eptwken <h BD, <h >ekt`oc gwn'ia <h <up`o GHB >'ish >est`i t~h| >ent`oc ka`i >apenant'ion t~h| <up`o ADB. >all> <h <up`o ADB t~h| <up`o ABD >estin >'ish, >epe`i ka`i pleur`a <h BA t~h| AD >estin >'ish;
ka`i <h <up`o GHB >'ara gwni'a t~h| <up`o HBG >estin >'ish; <'wste ka`i pleur`a <h BG pleur~a|  t~h| GH >estin >'ish;
>all> <h m`en GB t~h| HK >estin >'ish, <h d`e GH t~h| KB; ka`i <h HK >'ara t~h| KB >estin >'ish; >is'opleuron >'ara >est`i  t`o GHKB. l'egw d'h, <'oti ka`i >orjog'wnion. >epe`i g`ar par'allhl'oc >estin <h GH t~h| BK [ka`i e>ic a\kern -.7pt >ut`ac >emp'eptwken e>uje~ia <h GB], a<i >'ara <up`o KBG, HGB gwn'iai d'uo >orja~ic e>isin >'isai. >orj`h d`e <h <up`o KBG; >orj`h >'ara ka`i <h <up`o BGH; <'wste ka`i a<i >apenant'ion a<i <up`o GHK, HKB >orja'i e>isin. >orjog'wnion >'ara >est`i t`o GHKB; >ede'iqjh d`e ka`i >is'opleuron; tetr'agwnon >'ara >est'in; ka'i >estin >ap`o t~hc GB. di`a t`a a\kern -.7pt >ut`a d`h ka`i t`o JZ tetr'agwn'on >estin; ka'i >estin >ap`o t~hc JH, tout'estin [>ap`o] t~hc AG; t`a >'ara JZ, KG tetr'agwna >ap`o t~wn AG, GB e>isin. ka`i >epe`i >'ison >est`i t`o AH t~w| HE, ka'i >esti t`o AH t`o <up`o t~wn AG, GB; >'ish g`ar <h HG t~h| GB; ka`i t`o HE >'ara >'ison >est`i t~w| <up`o AG, GB; t`a >'ara AH, HE >'isa >est`i t~w| d`ic <up`o t~wn AG, GB. >'esti d`e ka`i t`a JZ, GK tetr'agwna >ap`o t~wn AG, GB; t`a >'ara t'essara t`a JZ, GK, AH, HE >'isa >est`i to~ic te >ap`o t~wn AG, GB tetrag'wnoic ka`i t~w| d`ic <up`o t~wn AG, GB perieqom'enw| >orjogwn'iw|. >all`a t`a JZ, GK, AH, HE <'olon >est`i
...
\gr{>E`an >'ara e>uje~ia gramm\kern -.7pt `h tm\kern -.7pt hj~h|, <wc >'etuqen, t`o >ap`o t~hc <'olhc tetr'agwnon >'ison >est`i to~ic te >ap`o t~wn tm\kern -.7pt hm'atwn tetrag'wnoic ka`i t~w| d`ic <up`o t~wn tm\kern -.7pt hm'atwn perieqom'enw| >orjogwn'iw|;
 <'oper >'edei de~ixai.}}
...
\gr{>E`an e>uje~ia gramm\kern -.7pt `h tm\kern -.7pt hj~h| e>ic >'isa ka`i >'anisa, t`o <up`o t~wn >an'iswn t~hc <'olhc tm\kern -.7pt hm'atwn perieq'omenon >orjog'wnion met`a to~u >ap`o t~hc metax`u t~wn tom~wn tetrag'wnou >'ison >est`i t~w|
>ap`o t~hc <hmise'iac tetrag'wnw|.}\\

\epsfysize=1.8in
\centerline{\epsffile{Book02/fig05g.eps}}

\gr{E>uje~ia g'ar tic <h AB tetm\kern -.7pt 'hsjw e>ic m`en >'isa kat`a t`o G, e>ic d`e >'anisa kat`a t`o D; l'egw, <'oti t`o <up`o t~wn AD, DB perieq'omenon >orjog'wnion met`a to~u >ap`o t~hc GD tetrag'wnou >'ison >est`i t~w| >ap`o t~hc GB tetrag'wnw|.}
...
\gr{>E`an >'ara e>uje~ia gramm\kern -.7pt `h tm\kern -.7pt hj~h| e>ic >'isa ka`i >'anisa, t`o <up`o t~wn
>an'iswn t~hc <'olhc tm\kern -.7pt hm'atwn perieq'omenon >orjog'wnion met`a to~u >ap`o t~hc metax`u t~wn tom~wn tetrag'wnou >'ison >est`i t~w|
...
\gr{>E`an e>uje~ia gramm\kern -.7pt `h tm\kern -.7pt hj~h| d'iqa, prostej~h| d'e tic a\kern -.7pt >ut~h| e>uje~ia >ep> e>uje'iac, t`o <up`o t~hc <'olhc s`un t~h| proskeim'enh| ka`i t~hc proskeim'enhc perieq'omenon >orj'og'wnion met`a to~u >ap`o t~hc <hmise'iac tetrag'wnou >'ison >est`i t~w| >ap`o t~hc sugkeim'enhc >'ek te t~hc <hmise'iac ka`i t~hc proskeim'enhc tetrag'wnw|.}\\~\\

\epsfysize=1.8in
\centerline{\epsffile{Book02/fig06g.eps}}

\gr{E>uje~ia g'ar tic <h AB tetm\kern -.7pt 'hsjw d'iqa kat`a t`o G shme~ion, proske'isjw d'e tic a\kern -.7pt >ut~h| e>uje~ia >ep> e>uje'iac <h BD; l'egw, <'oti t`o <up`o t~wn AD, DB perieq'omenon >orjog'wnion met`a to~u >ap`o t~hc GB
...
\gr{>E`an >'ara e>uje~ia gramm\kern -.7pt `h tm\kern -.7pt hj~h| d'iqa, prostej~h| d'e tic a\kern -.7pt >ut~h| e>uje~ia >ep> e>uje'iac, t`o <up`o t~hc <'olhc s`un t~h| proskeim'enh| ka`i t~hc proskeim'enhc perieq'omenon >orj'og'wnion met`a to~u >ap`o t~hc <hmise'iac tetrag'wnou >'ison >est`i t~w| >ap`o t~hc sugkeim'enhc >'ek te t~hc <hmise'iac ka`i t~hc proskeim'enhc tetrag'wnw|; <'oper >'edei de~ixai.}}
...
\gr{>E`an e>uje~ia gramm\kern -.7pt `h  tm\kern -.7pt hj~h|, <wc >'etuqen, t`o >ap`o t~hc <'olhc ka`i t`o >af> <en`oc t~wn tm\kern -.7pt hm'atwn t`a sunamf'otera tetr'agwna >'isa >est`i t~w| te d`ic <up`o t~hc <'olhc ka`i to~u e>irhm'enou tm\kern -.7pt 'hmatoc perieqom'enw| >orjogwn'iw| ka`i t~w| >ap`o to~u loipo~u tm\kern -.7pt 'hmatoc tetrag'wnw|.}

\epsfysize=2.2in
\centerline{\epsffile{Book02/fig07g.eps}}

\gr{E>uje~ia g'ar tic <h AB tetm\kern -.7pt 'hsjw, <wc >'etuqen, kat`a t`o G shme~ion; l'egw, <'oti t`a >ap`o t~wn AB, BG tetr'agwna >'isa >est`i t~w| te d`ic <up`o t~wn
...
>all`a <o KLM gn'wmwn ka`i t`a BH, HD tetr'agwna <'olon >est`i t`o ADEB ka`i t`o GZ,  <'a >estin >ap`o t~wn AB, BG
 ...
 \gr{>E`an >'ara e>uje~ia gramm\kern -.7pt `h  tm\kern -.7pt hj~h|, <wc >'etuqen, t`o >ap`o t~hc <'olhc ka`i t`o >af> <en`oc t~wn tm\kern -.7pt hm'atwn t`a sunamf'otera tetr'agwna >'isa >est`i t~w| te d`ic <up`o t~hc <'olhc ka`i to~u e>irhm'enou tm\kern -.7pt 'hmatoc perieqom'enw| >orjogwn'iw| ka`i t~w| >ap`o to~u loipo~u tm\kern -.7pt 'hmatoc tetrag'wnw|; <'oper >'edei de~ixai.}}
...
\gr{>E`an e>uje~ia gramm\kern -.7pt `h tm\kern -.7pt hj~h|, <wc >'etuqen, t`o tetr'akic <up`o t~hc <'olhc ka`i <en`oc t~wn tm\kern -.7pt hm'atwn perieq'omenon >orjog'wnion met`a to~u >ap`o to~u loipo~u tm\kern -.7pt 'hmatoc tetrag'wnou >'ison >est`i t~w| >ap'o te t~hc <'olhc ka`i to~u e>irhm'enou tm\kern -.7pt 'hmatoc <wc >ap`o mi~ac >anagraf'enti tetrag'wnw|.}

\gr{E>uje~ia g'ar tic <h AB tetm\kern -.7pt 'hsjw, <wc >'etuqen, kat`a t`o G shme~ion; l'egw, <'oti t`o tetr'akic <up`o t~wn AB, BG perieq'omenon >orjog'wnion met`a to~u >ap`o t~hc AG tetrag'wnou >'ison >est`i t~w| >ap`o t~hc AB, BG <wc >ap`o mi~ac >anagraf'enti tetrag'wnw|.}
...
\gr{>Epe`i o>~un >'ish >est`in <h GB t~h| BD, >all`a <h m`en GB t~h| HK >estin >'ish, <h d`e BD t~h| KN, ka`i <h HK >'ara t~h| KN >estin >'ish. di`a t`a a\kern -.7pt >ut`a d`h ka`i <h PR t~h| RO >estin >'ish. ka`i >epe`i >'ish >est`in <h BG
...
\gr{>E`an >'ara  e>uje~ia gramm\kern -.7pt `h tm\kern -.7pt hj~h|, <wc >'etuqen, t`o tetr'akic <up`o t~hc <'olhc ka`i <en`oc t~wn tm\kern -.7pt hm'atwn perieq'omenon >orjog'w\-nion met`a to~u >ap`o to~u loipo~u tm\kern -.7pt 'hmatoc tetrag'wnou >'isou >est`i t~w| >ap'o te t~hc <'olhc ka`i to~u e>irhm'enou tm\kern -.7pt 'hmatoc <wc >ap`o mi~ac >anagraf'enti tetrag'wnw|;  <'oper >'edei de~ixai.}}
...
\gr{>E`an e>uje~ia gramm\kern -.7pt `h tm\kern -.7pt hj~h| e>ic >'isa ka`i >'anisa, t`a >ap`o t~wn >an'iswn t~hc <'olhc tm\kern -.7pt hm'atwn tetr'agwna dipl'asi'a >esti to~u te >ap`o t~hc <hmise'iac ka`i to~u >ap`o t~hc metax`u t~wn tom~wn tetrag'wnou.}

\gr{E>uje~ia g'ar tic <h AB tetm\kern -.7pt 'hsjw e>ic m`en >'isa kat`a t`o G, e<ic d`e >'anisa kat`a t`o D; l'egw, <'oti t`a >ap`o t~wn AD, DB tetr'agwna dipl'asi'a >esti t~wn >ap`o t~wn AG, GD tetrag'wnwn.}
...
\gr{>E`an >'ara e>uje~ia gramm\kern -.7pt `h tm\kern -.7pt hj~h| e>ic >'isa ka`i >'anisa, t`a >ap`o t~wn >an'iswn t~hc <'olhc tm\kern -.7pt hm'atwn tetr'agwna dipl'asi'a >esti to~u te >ap`o t~hc <hmise'iac ka`i to~u >ap`o t~hc metax`u t~wn tom~wn tetrag'wnou;
<'oper >'edei de~ixai.}}
...
\gr{>E`an e>uje~ia gramm\kern -.7pt `h tm\kern -.7pt hj~h| d'iqa, prostej~h| d'e tic a\kern -.7pt >ut~h| e>uje~ia  >ep> e>uje'iac, t`o >ap`o t~hc <'olhc s`un t~h| proskeim'enh|
...
\gr{E>uje~ia g'ar tic <h AB tetm\kern -.7pt 'hsjw d'iqa kat`a t`o G, proske'isjw d'e tic a\kern -.7pt >ut~h|
...
>orj~hc [>estin] <ekat'era t~wn <up`o EAG, AEG. di`a t`a a\kern -.7pt >ut`a d`h ka`i <ekat'era t~wn <up`o GEB, EBG <hm'isei'a >estin >orj~hc; >orj`h >'ara >est`in <h <up`o AEB. ka`i >epe`i <hm'iseia >orj~hc >estin <h <up`o EBG, <hm'iseia >'ara 
...
\gr{>E`an >'ara e>uje~ia gramm\kern -.7pt `h tm\kern -.7pt hj~h| d'iqa, prostej~h| d'e tic a\kern -.7pt >ut~h| e>uje~ia  >ep> e>uje'iac, t`o >ap`o t~hc <'olhc s`un t~h| proskeim'enh|
...
to~u <et'erou t~wn tm\kern -.7pt hm'atwn perieq'omenon >orjog'wnion >'ison e>~inai
t~w| >ap`o to~u loipo~u tm\kern -.7pt 'hmatoc tetrag'wnw|.}

\gr{>'Estw <h doje~isa e>uje~ia <h AB; de~i d`h t`hn AB teme~in <'wste
t`o <up`o t~hc <'olhc ka`i to~u <et'erou t~wn tm\kern -.7pt hm'atwn perieq'omenon >orjog'wnion >'ison e>~inai t~w| >ap`o to~u loipo~u tm\kern -.7pt 'hmatoc tetrag'wnw|.}\\

\epsfysize=2.75in
\centerline{\epsffile{Book02/fig11g.eps}}

\gr{>Anagegr'afjw g`ar >ap`o t~hc AB tetr'agwnon t`o ABDG, ka`i tetm\kern -.7pt 'hsjw <h AG d'iqa kat`a t`o E shme~ion, ka`i >epeze'uqjw <h BE, ka`i di'hqjw <h GA >ep`i t`o Z, ka`i ke'isjw t~h| BE >'ish <h EZ, ka`i >anagegr'afjw >ap`o
t~hc AZ tetr'agwnon t`o ZJ, ka`i
di'hqjw <h HJ >ep`i t`o K; l'egw, <'oti <h AB t'etm\kern -.7pt htai kat`a t`o J, <'wste t`o <up`o t~wn AB, BJ perieq'omenon >orjog'wnion >'ison poie~in t~w| >ap`o t~hc AJ tetrag'wnw|.}

\gr{>Epe`i g`ar e>uje~ia <h AG t'etm\kern -.7pt htai d'iqa kat`a t`o E, pr'oskeitai d`e a\kern -.7pt >ut~h| <h ZA, t`o >'ara <up`o t~wn GZ, ZA perieq'omenon >orjog'wnion met`a to~u >ap`o t~hc AE tetrag'wnou >'ison >est`i t~w| >ap`o t~hc EZ tetrag'wnw|. >'ish d`e <h EZ t~h| EB; t`o >'ara <up`o t~wn GZ, ZA met`a to~u >ap`o t~hc AE >'ison >est`i t~w| >ap`o EB. >all`a t~w| >ap`o 
...
\gr{<H  >'ara doje~isa e>uje~ia <h AB t'etm\kern -.7pt htai 
...
\gr{>Epe`i g`ar e>uje~ia <h GD t'etm\kern -.7pt htai, <wc >'etuqen, kat`a t`o A shme~ion,
...
\gr{>Epe`i g`ar e>uje~ia <h GB t'etm\kern -.7pt htai, <wc >'etuqen, kat`a t`o D, t`a >'ara >ap`o t~wn GB, BD tetr'agwna >'isa >est`i t~w| te d`ic <up`o t~wn GB, BD
...
\gr{T~w| doj'enti e>ujugr'ammw| >'ison tetr'agwnon sust'hsasjai.}
...
<h EZ, ka`i tetm\kern -.7pt 'hsjw <h BZ d'iqa kat`a t`o H, ka`i k'entrw| t~w| H,
diast'hmati d`e <en`i t~wn HB, HZ <hmik'uklion gegr'afjw t`o BJZ, ka`i
>ekbebl'hsjw <h DE >ep`i t`o J, ka`i >epeze'uqjw <h HJ.}

\gr{>Epe`i o>~un e>uje~ia <h BZ t'etm\kern -.7pt htai e>ic m`en >'isa kat`a t`o H, e>ic
