...
\gr{>'Estwsan k'ukloi o<i ABG, ZHJ, ka`i >en a\kern -.7pt >uto~ic
...
<up`o AEB t~h| <up`o AMB >estin >'ish; >ep`i g`ar t~hc a\kern -.7pt >ut~hc
...
\gr{>'Estwsan k'ukloi o<i ABGD, EZHJ, di'ametroi d`e a\kern -.7pt >ut~wn [>'estwsan]
...
\gr{E>i g`ar m\kern -.7pt 'h >estin <wc <o ABGD k'ukloc pr`oc t`on EZHJ, o<'utwc t`o >ap`o
...
EZHJ  >eggegramm'enom\kern -.7pt ~hn tetr'agwnon me~iz'on >esti to~u 
<hm'isewc to~u EZHJ k'uklou. tetm\kern -.7pt 'hsjwsan d'iqa a<i EZ, ZH, HJ, JE perif'ereiai kat`a
...
>`h t`o <'hmisu to~u kaj> <eaut`o tm\kern -.7pt 'hmatoc to~u k'uklou, >epeid'hper
...
parallhlogr'ammou, >all`a t`o kaj> <eaut`o tm\kern -.7pt ~hma >'elatt'on >esti to~u
parallhlogr'ammou; <'wste <'ekaston t~wn EKZ, ZLH, HMJ, JNE
trig'wnwn me~iz'on >esti to~u <hm'isewc to~u kaj> <eaut`o tm\kern -.7pt 'hmatoc
to~u k'uklou. t'emnontec d`h t`ac <upoleipom'enac perifere'iac d'iqa ka`i
>epizeugn'untec e>uje'iac ka`i to~uto >ae`i poio~untec katale'iyom'en tina >apotm\kern -.7pt 'hmata
...
\gr{Tetm\kern -.7pt 'hsjwsan g`ar a<i AB, BG, GA, AD, DB, DG d'iqa kat`a t`a E, Z, H, J, K, L
shme~ia, ka`i >epeze'uqjwsan a<i JE, EH, HJ, JK, KL, LJ, KZ,
ZH. >epe`i >'ish >est`in <h m`en AE t~h| EB, <h d`e AJ t~h| DJ, par'allhloc
>'ara >est`in <h EJ t~h| DB. di`a t`a a\kern -.7pt >ut`a d`h ka`i <h JK t~h| AB par'allhl'oc
...
>'ara ka`i <'omoi'on >esti t`o AEJ tr'igwnon t~w| JKD trig'wnw|. di`a t`a a\kern -.7pt >ut`a
...
<aptom'enac >all'hlwn t`ac KD, DL e>isin o>uk >en t~w| a\kern -.7pt >ut~w|
...
a\kern -.7pt >ut`a d`h ka`i t`o AEH tr'igwnon t~w| JKL trig'wnw| >'ison te ka`i <'omoi'on
...
<'omoion >'ara >est`i t`o ADB tr'igwnon t~w| DJK trig'wnw|. di`a t`a a\kern -.7pt >ut`a d`h ka`i
...
a\kern -.7pt >ut~w| >epip'edw|, >'isac gwn'iac peri'exousin. >'ish >'ara >est`in <h <up`o
...
\gr{>E`an >~wsi d'uo puram'idec <up`o t`o a\kern -.7pt >ut`o <'uyoc trig'wnouc >'eqousai b'aseic, diairej~h|
d`e <ekat'era a\kern -.7pt >ut~wn e>'ic te d'uo puram'idac >'isac >all'hlaic ka`i <omo'iac 
t~h|
...
\gr{>'Estwsan d'uo puram'idec <up`o t`o a\kern -.7pt >ut`o <'uyoc trig'wnouc >'eqousai b'aseic t`ac ABG,
DEZ, koruf`ac d`e t`a H, J shme~ia, ka`i dih|r'hsjw <ekat'era a\kern -.7pt >ut~wn e>'ic te d'uo
...
<h LX t~h| AB ka`i <'omoion t`o ABG tr'igwnon t~w| LXG trig'wnw|. di`a t`a a\kern -.7pt >ut`a
...
\gr{>Ep`i g`ar t~hc a\kern -.7pt >ut~hc katagraf~hc neno'hsjwsan >ap`o t~wn H, J k'ajetoi
...
<up`o parall'hlwn >epip'edwn t~wn ABG, OMN t'emnontai, e>ic to`uc a\kern -.7pt >uto`uc
l'ogouc tm\kern -.7pt hj'hsontai. ka`i t'etm\kern -.7pt htai <h HG d'iqa <up`o to~u OMN >epip'edou
kat`a t`o N; ka`i <h >ap`o to~u H >'ara k'ajetoc >ep`i t`o ABG >ep'ipedon d'iqa tm\kern -.7pt hj'hsetai
<up`o to~u OMN >epip'edou. di`a t`a a\kern -.7pt >ut`a d`h ka`i <h >ap`o to~u J k'ajetoc
>ep`i t`o DEZ >ep'ipedon d'iqa tm\kern -.7pt hj'hsetai <up`o to~u STU
...
\gr{A<i <up`o t`o a\kern -.7pt >ut`o <'uyoc o>~usai puram'idec ka`i trig'wnouc >'eqousai b'aseic pr`oc >all'hlac
e>is`in <wc a<i b'aseic.}

\epsfysize=1.4in
\centerline{\epsffile{Book12/fig05g.eps}}

\gr{>'Estwsan <up`o t`o a\kern -.7pt >ut`o <'uyoc puram'idec, <~wn b'aseic m`en t`a ABG, DEZ tr'igwna, korufa`i d`e
t`a H, J shme~ia; l'egw, <'oti >est`in <wc <h ABG b'asic pr`oc t`hn DEZ b'asin, o<'utwc <h ABGH
puram`ic pr`oc t`hn DEZJ puram'ida.}

\gr{E>i g`ar m\kern -.7pt 'h >estin <wc <h ABG b'asic pr`oc t`hn DEZ b'asin, o<'utwc <h ABGH puram`ic pr`oc
...
puram'idi pr'ismata; >enall`ax >'ara <wc <h ABGH puram`ic pr`oc t`a >en a\kern -.7pt >ut~h| pr'ismata,
o<'utwc t`o Q stere`on pr`oc t`a >en t~h| DEZJ puram'idi pr'ismata. me'izwn d`e <h ABGH puram`ic
t~wn >en a\kern -.7pt >ut~h| prism'atwn; me~izon >'ara ka`i t`o Q stere`on t~wn >en t~h| DEZJ
...
\gr{A<i >up`o t`o a\kern -.7pt >ut`o <'uyoc o>~usai puram'idec ka`i polug'wnouc
>'eqousai b'aseic pr`oc >all'hlac e>is`in <wc a<i b'aseic.}\\

\epsfysize=2.in
\centerline{\epsffile{Book12/fig06g.eps}}

\gr{>'Estwsan <up`o t`o a\kern -.7pt >ut`o <'uyoc puram'idec, <~wn [a<i] b'aseic
...
<h ABGDEM puram`ic pr`oc t`hn ZHJN puram'ida. >all`a m\kern -.7pt `hn ka`i
...
d`e a\kern -.7pt >ut`o~u >estin <h BD,  >'ison >'ara >esti t`o ABD tr'igwnon t~w| EBD tr'igwnw|; ka`i
...
<~hc b'asic m'en >esti t`o DEB tr'igwnon, koruf`h d`e t`o G shme~ion, <h a\kern -.7pt >ut'h >esti puram'idi,
<~hc b'asic m'en >esti t`o EBG tr'igwnon, koruf`h d`e t`o D shme~ion; <up`o g`ar t~wn a\kern -.7pt >ut~wn
...
>epe`i parallhl'ogramm'on >esti t`o ZGBE, di'ametroc d'e >estin a\kern -.7pt >uto~u <h GE, >'ison >est`i t`o GEZ
...
<h a\kern -.7pt >ut'h >esti puram'idi, <~hc b'asic t`o GAB tr'igwnon, koruf`h d`e t`o D shme~ion; <up`o
g`ar t~wn a\kern -.7pt >ut~wn >epip'edwn peri'eqontai; <h d`e puram'ic, <~hc b'asic t`o ABD tr'igwnon,
...
tr'iton >est`i to~u pr'ismatoc to~u >'eqontoc b'asic t`hn a\kern -.7pt >ut`hn t`o ABG tr'igwnon, >apenant'ion
d`e t`o DEZ.}}
...
\gr{>Ek d`h to'utou faner'on, <'oti p~asa puram`ic tr'iton m'eroc >est`i to~u pr'ismatoc to~u t`hn a\kern -.7pt >ut`hn
b'asin >'eqontoc a\kern -.7pt >ut~h| ka`i <'uyoc >'ison; <'oper >'edei de~ixai.}}
...
di`a t`a a\kern -.7pt >ut`a d`h ka`i t`o m`en BN t~w| ER <'omoi'on >esti, t`o d`e BK t~w| EX; t`a
...
diairejeis~wn g`ar a\kern -.7pt >ut~wn e>ic t`ac >en a\kern -.7pt >uta~ic puram'idac trig'wnouc b'aseic
...
a\kern -.7pt >ut`h <h pol'ugwnon b'asin >'eqousa puram`ic pr`oc t`hn  pol'ugwnon b'asin >'eqousan puram'ida. <h d`e tr'igwnon b'asin >'eqousa puram`ic
...
<'uyoc t`o a\kern -.7pt >ut`o >esti t~w| t~hc DEZJ puram'idoc <'uyei,
t`o d`e to~u BHML stereo~u <'uyoc t`o a\kern -.7pt >ut'o >esti t~w| t~hc
...
\gr{T~wn g`ar a\kern -.7pt >ut~wn kataskeuasj'entwn, >epe'i >estin <wc <h ABG b'asic
...
<'uyoc. >all`a t`o [m`en] t~hc DEZJ puram'idoc <'uyoc t`o a\kern -.7pt >ut'o >esti
t~w| to~u EJPO parallhlepip'edou
<'uyei, t`o d`e t~hc ABGH puram'idoc <'uyoc t`o a\kern -.7pt >ut'o
...
\gr{P~ac k~wnoc kul'indrou tr'iton m'eroc >est`i to~u t`hn a\kern -.7pt >ut`hn b'asin >'eqontoc a\kern -.7pt >ut~w| ka`i <'uyoc >'ison.}

\gr{>Eq'etw g`ar k~wnoc kul'indr~w| b'asin te t`hn a\kern -.7pt >ut`hn t`on ABGD k'uklon ka`i <'uyoc >'ison; l'egw, <'oti
...
\gr{E>i g`ar m\kern -.7pt 'h >estin <o k'ulindroc to~u k'wnou triplas'iwn, >'estai <o k'ulindroc to~u k'wnou >'htoi me'izwn
...
<'hmis'u >esti to~u perigegramm'enou; ka'i >esti t`a >ap> a\kern -.7pt >ut~wn >anist'amena stere`a parallhlep'ipeda pr'ismata
>iso"uy~h; t`a d`e <up`o t`o a\kern -.7pt >ut`o <'uyoc >'onta stere`a parallhlep'ipeda pr`oc >'allhl'a >estin <wc a<i b'aseic;
...
<hm'isewc to~u kul'indrou. tetm\kern -.7pt 'hsjwsan a<i AB, BG, GD, DA perif'ereiai d'iqa kat`a t`a E, Z, H, J shme~ia,
...
<'hmisu m'eroc to~u kaj> <eaut`o tm\kern -.7pt 'hmatoc to~u kul'indrou, >epeid'hper >e`an di`a t~wn E, Z, H, J
shme'iwn parall'hlouc ta~ic AB, BG, GD, DA >ag'agwmen, ka`i 
sumplhr'wswmen t`a >ep`i t~wn AB, 
BG, GD, DA parallhl'ogramma, ka`i  >ap> a\kern -.7pt >ut~wn >anast'hswmen stere`a  parallhlep'ipeda >iso"uy~h
t~w| kul'indrw|, <ek'asou t~wn >anastaj'entwn <hm'ish >est`i t`a pr'ismata t`a >ep`i t~wn
AEB, BZG, GHD, DJA trig'wnwn;  ka'i >esti t`a to~u kul'indrou tm\kern -.7pt 'hmata >el'attona t~wn >anastaj'entwn
stere~wn parallhlepip'edwn; <'wste ka`i t`a >ep`i t~wn AEB, BZG, GHD, DJA trig'wnwn pr'ismata me'izon'a
>estin >`h t`o <'hmisu t~wn kaj> <eaut`a to~u kul'indrou tm\kern -.7pt hm'atwn. t'emnontec d`h t`ac <upoleipom'enac perifere'iac
...
>ap`o to~u ABGD tetrag'wnou puram`ic t`hn a\kern -.7pt >ut`hn koruf`hn >'eqousa t~w| k'wnw|; >h >'ara >anastaje~isa
...
>emperi'eqei g`ar a\kern -.7pt >ut'on. <h >'ara puram`ic, <~hc b'asic t`o ABGD tetr'agwnon, koruf`h d`e <h a\kern -.7pt >ut`h
t~w| k'wnw|, me'izwn >est`in >`h t`o <'hmisu to~u k'wnou. tetm\kern -.7pt 'hsjwsan a<i AB, BG, GD, DA perif'ereiai
...
<eaut`o tm\kern -.7pt 'hmatoc  to~u ABGD k'uklou.
ka`i >anest'atwsan
>ef> <ek'astou t~wn AEB, BZG, GHD, DJA trig'wnwn puram'idec t`hn a\kern -.7pt >ut`hn koruf`hn >'eqousai t~w|
k'wnw|; ka`i <ek'asth >'ara t~wn >anastajeis~wn puram'idwn kat`a t`on a\kern -.7pt >ut`on tr'opon
me'izwn >est`in >`h t`o <'hmisu m'eroc to~u kaj> <eaut`hn tm\kern -.7pt 'hmatoc to~u k'wnou. t'emnontec d`h t`ac
<upoleipom'enac perifere'iac d'iqa ka`i >epizeugn'untec e>uje'iac ka`i >anist'antec >ef> <ek'astou t~wn
trig'wnwn puram'ida t`hn a\kern -.7pt >ut`hn koruf`hn >'eqousan t~w| k'wnw| ka`i to~uto >ae`i poio~utec
katale'iyom'en tina >apotm\kern -.7pt 'hmata to~u k'wnou, <`a >'estai >el'attona t~hc <uperoq~hc, <~h| <uper'eqei
...
\gr{P~ac >'ara k~wnoc kul'indrou tr'iton m'eroc >est`i to~u t`hn a\kern -.7pt >ut`hn b'asin >'eqontoc a\kern -.7pt >ut~w| ka`i
...
\gr{O<i <upo t`o a\kern -.7pt >ut`o <'uyoc >'ontec k~wnoi ka`i k'ulindroi pr`oc >all'hlouc
e>is`in <wc a<i b'aseic.}

\gr{>'Estwsan <up`o t`o a\kern -.7pt >ut`o <'uyoc k~wnoi ka`i k'ulindroi, <~wn
...
\gr{E>i g`ar m\kern -.7pt 'h, >'estai <wc <o ABGD k'ukloc pr`oc t`on EZHJ k'uklon,
...
per`i t`on k'uklon tetr'agwnon, ka`i >ap> a\kern -.7pt >uto~u >anast'hswmen
...
tetm\kern -.7pt 'hsjwsan a<i EZ, ZH, HJ, JE perif'ereiai d'iqa kat`a t`a O, P, R, S
shme~ia, ka`i >epeze'uqjwsan a<i JO, OE, EP, PZ, ZR, RH, HS, SJ.
<'ekaston >'ara t~wn JOE, EPZ, ZRH, HZJ trig'wnwn me~iz'on
>estin >`h t`o <'hmisu to~u kaj> <eaut`o tm\kern -.7pt 'hmatoc to~u k'uklou.
...
kaj> <eaut`hn tm\kern -.7pt 'hmatoc to~u k'wnou. t'emnontec d`h t`ac <upoleipom'enac
...
ka`i >ae`i to~uto poio~untec katale'iyom'en tina >apotm\kern -.7pt 'hmata to~u
k'wnou, <`a >'estai >el'assona to~u Y stereo~u. 
lele'ifjw, ka`i >'estw t`a >ep`i t~wn JOE, EPZ, ZRH, HSJ; 
loip`h >'ara <h puram'ic, <~hc b'asic t`o JOEPZRHS pol'ugwnon, <'uyoc d`e t`o a\kern -.7pt >ut`o t~w|
...
a\kern -.7pt >uto~u puram`ic >iso"uy`hc t~w| AL k'wnw|. 
...
>'ara >est`in <wc <o AL k~wnoc pr`oc t`hn >en a\kern -.7pt >ut~w|
puram'ida, o<'utwc t`o X stere`on pr`oc t`hn >en t~w| EN k'wnw|
puram'ida. me'izwn d`e <o AL k~wnoc t~hc >en a\kern -.7pt >ut~w| puram'idoc;
...
a\kern -.7pt >ut~wn >iso"uye~ic.}

\gr{O<i >'ara <up`o t`o a\kern -.7pt >ut`o <'uyoc >'ontec k~wnoi ka`i k'ulindroi pr`oc
...
\gr{E>i g`ar m\kern -.7pt `h >'eqei <o ABGDL k~wnoc pr`oc t`on EZHJN k~wnon priplas'iona
...
puram`ic t`hn a\kern -.7pt >ut`hn koruf`hn >'eqousa t~w| k'wnw|; <h >'ara >anastaje~isa
puram`ic me'izwn >est`in >`h t`o <'hmisu m'eroc to~u k'wnou. tetm\kern -.7pt 'hsjwsan
...
m'eroc to~u kaj> <eaut`o tm\kern -.7pt 'hmatoc to~u EZHJ k'uklou. ka`i >anest'atw
>ef> <ek'astou t~wn EOZ, ZPH, HRJ, JSE trig'wnwn
puram`ic t`hn a\kern -.7pt >ut`hn koruf`hn >'eqousa t~w| k'wnw|; ka`i <ek'asth >'ara t~wn
>anastajeis~wn puram'idwn me'izwn >est`in >`h t`o <'hmisu m'eroc to~u kaj> <eaut`hn
tm\kern -.7pt 'hmatoc to~u k'wnou.
 t'emnontec d`h t`ac <upoleipom'enac perifere'iac
d'iqa ka`i >epizeugn'untec e>uje'iac ka`i >anist'antec >ef> <ek'astou
t~wn trig'wnwn puram'idac t`hn a\kern -.7pt >ut`hn koruf`hn >eqo'usac t~w| k'wnw| ka`i
to~uto >ae`i poio~untec katale'iyom'en tina >apotm\kern -.7pt 'hmata to~u k'wnou, <`a >'estai
...
to~u ATBUGFDQ polug'wnou puram`ic t`hn a\kern -.7pt >ut`hn koruf`hn >'eqousa
...
to~u k'wnou <o >ep`i  t~hc a\kern -.7pt >ut~hc b'asewc t~w| k'wnw| ka`i >iso"uy`hc a\kern -.7pt >ut~w|. ka`i <o k'ulindroc >'ara pr`oc t`on
...
\gr{>E`an k'ulindroc >epip'edw| tm\kern -.7pt hj~h| parall'hlw| >'onti to~ic >apenant'ion >epip'edoic, >'estai <wc <o k'ulindroc
pr`oc t`on k'ulindron, o<'utwc <o >'axwn pr`oc t`on >'axona.}

\epsfysize=1.1in
\centerline{\epsffile{Book12/fig13g.eps}}

\gr{K'ulindroc g`ar <o AD >epip'edw| t~w| HJ tetm\kern -.7pt 'hsjw parall'hlw| >'onti to~ic >apenant'ion >epip'edoic to~ic
...
di`a t`a a\kern -.7pt >ut`a d`h ka`i <osaplas'iwn >est`in <o MK >'axwn to~u KZ >'axonoc, tosautaplas'iwn
...
<up`o t`o a\kern -.7pt >ut`o <'uyoc e>is'in, pr`oc >all'hlouc e>is`in <wc a<i b'aseic. >'isai d'e e>is'in a<i
b'aseic >all'hlaic; >'isoi >'ara e>is`i ka`i o<i EB, GM k'ulindroi. ka`i >epe`i k'ulindroc <o ZM >epip'edw|
t'etm\kern -.7pt htai t~w| GD parall'hlw| >'onti to~ic >apenant'ion >epip'edoic, >'estin >'ara <wc <o GM k'ulindroc
...
a\kern -.7pt >ut~wn a<i AG, EH, <'axonec d`e o<i KL, MN, o<'itinec ka`i <'uyh e>is`i t~wn k'wnwn >`h kul'indrwn, ka`i
...
<o AX k'ulindroc t~w| EO kul'indrw| >'isoc. o<i d`e <up`o t`o a\kern -.7pt >ut`o <'uyoc >'ontec k~wnoi ka`i k'ulindroi
...
KL <'uyoc. >all`a d`h m\kern -.7pt `h >'estw t`o LK <'uyoc t~w| MN >'ison, >all> >'estw me~izon t`o MN, 
ka`i >afh|r'hsjw >ap`o to~u MN <'uyouc t~w| KL >'ison t`o PN, ka`i di`a to~u P shme'iou tetm\kern -.7pt 'hsjw <o
...
o<'utwc <h ABGD b'asic pr`oc t`hn EZHJ; <up`o g`ar t`o  a\kern -.7pt >ut`o <'uyoc e>is`in o<i AX, ES k'ulindroi; <wc
d`e <o EO k'ulindroc pr`oc  t`on ES, o<'utwc t`o MN  <'uyoc pr`oc t`o PN <'uyoc; <o g`ar EO k'ulindroc >epip'edw|
t'etm\kern -.7pt htai parall'hlw| >'onti to~ic >apenant'ion >epip'edoic.  >'estin >'ara ka`i <wc <h ABGD b'asic pr`oc t`hn EZHJ b'asin, o<'utwc t`o MN <'uyoc pr`oc t`o PN
...
\gr{T~wn g`ar a\kern -.7pt >ut~wn kataskeuasj'entwn >epe'i >estin <wc <h ABGD b'asic pr`oc t`hn EZHJ b'asin, o<'utwc
...
pr`oc t`hn EZHJ b'asin, o<'utwc <o AX k'ulindroc pr`oc t`on ES k'ulindron; <up`o g`ar t`o a\kern -.7pt >ut`o
...
\gr{D'uo k'uklwn per`i t`o a\kern -.7pt >ut`o k'entron >'ontwn e>ic t`on me'izona k'uklon pol'ugwnon >is'opleur'on te ka`i >arti'opleu\-ron
>eggr'ayai m\kern -.7pt `h ya\kern -.7pt ~uon to~u >el'assonoc k'uklou.}

\epsfysize=2in
\centerline{\epsffile{Book12/fig16g.eps}}

\gr{>'Estwsan o<i doj'entec d'uo k'ukloi o<i ABGD, EZHJ per`i t`o a\kern -.7pt >ut`o k'entron t`o K; de~i d`h e>ic t`on me'izona k'uklon t`on ABGD pol'ugwnon >is'opleur'on te ka`i >arti'opleuron >eggr'ayai m\kern -.7pt `h ya\kern -.7pt ~uon to~u EZHJ k'uklou.}
...
d'iqa ka`i t`hn <hm'iseian a\kern -.7pt >ut~hc d'iqa ka`i to~uto >ae`i poio~untec katale'iyomen perif'ereian >el'assona
...
pol'ugwnon >is'opleur'on te ka`i >arti'opleuron m\kern -.7pt `h ya\kern -.7pt ~uon to~u >el'assonoc k'uklou to~u EZHJ; <'oper >'edei poi~hsai.}}
...
\gr{D'uo sfair~wn per`i t`o a\kern -.7pt >ut`o k'entron o>us~wn e>ic t`hn me'izona sfa~iran stere`on pol'uedron >eggr'ayai m\kern -.7pt `h ya\kern -.7pt ~uon
t~hc >el'assonoc sfa'irac kat`a t`hn >epif'aneian.}

\epsfysize=3.4in
\centerline{\epsffile{Book12/fig17g.eps}}

\gr{Neno'hsjwsan d'uo sfa~irai per`i t`o a\kern -.7pt >ut`o k'entron t`o A; de~i d`h e>ic t`hn me'izona sfa~iran stere`on pol'uedron
>eggr'ayai m\kern -.7pt `h ya\kern -.7pt ~uon t~hc >el'assonoc sfa'irac kat`a t`hn >epif'aneian.}

\gr{Tetm\kern -.7pt 'hsjwsan a<i sfa~irai >epip'edw| tin`i di`a to~u k'entrou; >'esontai d`h a<i toma`i k'ukloi,
>epeid'hper meno'ushc t~hc diam'etrou ka`i periferom'enou to~u <hmikukl'iou >egigneto <h sfa~ira; <'wste ka`i kaj>
o<'iac >`an j'esewc >epino'hswmen t`o <hmik'uklion, t`o di> a\kern -.7pt >uto~u >ekball'omenon >ep'ipedon poi'hsei >ep`i
...
o>~un >en m`en t~h| me'izoni sfa'ira| k'ukloc <o BGDE, >en d`e t~h| >el'assoni sfa'ira| k'ukloc <o ZHJ, ka`i >'hqjwsan a\kern -.7pt >ut~wn
d'uo di'ametroi pr`oc >orj`ac >all'hlaic a<i BD, GE, ka`i d'uo k'uklwn per`i t`o a\kern -.7pt >ut`o k'entron >'ontwn t~wn BGDE, ZHJ
e>ic t`on me'izona k'uklon t`on BGDE pol'ugwnon >is'opleuron ka`i >arti'opleuron >eggegr'afjw m\kern -.7pt `h ya\kern -.7pt ~uon
...
pleura`i to~u polug'wnou, tosa\kern -.7pt ~uta'i e>isi ka`i >en to~ic BX, KX tetarthmor'ioic >'isai ta~ic BK, KL, LM, ME e>uje'iaic.
...
pr`oc t`o to~u KBOS tetraple'urou >ep'ipedon, ka`i pr`oc p'asac >'ara t`ac <aptom'enac a\kern -.7pt >ut~hc e>uje'iac
...
\gr{D'uo >'ara sfair~wn per`i t`o a\kern -.7pt >ut`o k'entron o>us~wn e>ic t`hn me'izona sfa~iran stere`on pol'uedron
>egg'egraptai m\kern -.7pt `h ya\kern -.7pt ~uon t~hc >el'assonoc sfa'irac kat`a t`hn >epif'aneian; <'oper >'edei poi~hsai.}}
...
\gr{Neno'hsjwsan sfa~irai a<i ABG, DEZ, di'ametroi d`e a\kern -.7pt >ut~wn a<i BG, EZ; l'egw, <'oti <h ABG
sfa~ira pr`oc t`hn DEZ sfa~iran triplas'iona l'ogon >'eqei >'hper <h BG pr`oc t`hn EZ.}

\gr{E>i g`ar m\kern -.7pt `h <h ABG sfa~ira pr`oc t`hn DEZ sfa~iran triplas'iona l'ogon >'eqei >'hper
...
pr`oc >el'assona t`hn HJK, ka`i neno'hsjw <h DEZ t~h| HJK per`i t`o a\kern -.7pt >ut`o k'entron, ka`i
>eggegr'afjw e>ic t`hn me'izona sfa~iran t`hn DEZ stere`on pol'uedron m\kern -.7pt `h ya\kern -.7pt ~uon
...
[>'ara] <wc <h ABG sfa~ira pr`oc t`o >en a\kern -.7pt >ut~h| pol'uedron, o<'utwc <h HJK
sfa~ira pr`oc t`o >en t~h| DEZ sfa'ira| stere`on pol'uedron. me'izwn d`e <h
ABG sfa~ira to~u >en a\kern -.7pt >ut~h| polu'edrou; me'izwn
>'ara ka`i <h HJK sfa~ira to~u >en t~h| DEZ sfa'ira| polu'edrou. >all`a ka`i >el'attwn;
>emperi'eqetai g`ar <up> a\kern -.7pt >uto~u. o>uk >'ara <h ABG sfa~ira pr`oc >el'assona
